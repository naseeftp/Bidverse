            ...
            <div className="flex flex-col gap-1.5 pt-2 border-t border-[#E6E0DA]/50">
               ...
               :(
                ...
                <div className="grid grid-cols-2 gap-1.5">
                    ...
                    <button className="w-full bg-white hover:bg-[#FFF9F4] border border-[#E6E0DA] text-[#C9653B] hover:text-[#C9653B]/90 font-bold text-[10px] py-1 rounded-md transition-all focus:outline-none flex items-center justify-center gap-1">
