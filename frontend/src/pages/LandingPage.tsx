...
const LandingPage: React.FC = () => {
  return (
    // MAIN BACKGROUND: #FFF9F4 (Warm Cream)
    <div className="bg-[#FFF9F4] min-h-screen">
      ...
      <section className="px-8 py-24 md:py-40 flex flex-col items-center text-center border-b border-[#E6E0DA]">
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          {/* PRIMARY CTA: #C9653B (Burnt Orange) */}
          <Link
            to="/register"
          ...
          {/* SECONDARY BUTTON: Border matches Primary Text */}
      ...
      {/* 2. FEATURES SECTION - Cards: #FFFFFF */}
